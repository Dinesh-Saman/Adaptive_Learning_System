...
export default function SinhalaGrade4AdaptiveSystem({ onExit }) {
  ...
  return (
    ...
    >
      ...
      {/* ── Top Navigation Bar ── */}
      <header className="bg-white/90 backdrop-blur-md sticky top-0 z-30 border-b border-indigo-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-3.5 flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-2 text-indigo-800 hover:text-indigo-950 font-bold text-sm bg-indigo-50 hover:bg-indigo-100 px-3.5 py-2 rounded-2xl transition-all cursor-pointer"
          >
      ...
      <main className="max-w-5xl mx-auto px-4 pt-8">
            ...
            <div className="bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 rounded-[2.5rem] p-6 md:p-10 text-white shadow-xl relative overflow-hidden">
              ...
              <div className="max-w-2xl">
                <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-3.5 py-1.5 rounded-full text-xs font-bold mb-4 border border-white/30">
                  ...
                  <span>4 ශ්‍රේණිය සිංහල අනුවර්‍තී ඇගයීම් මාලාව (Papers 1–5 + Tracing AI)</span>
                </div>
                ...
                <p className="text-indigo-100 text-sm md:text-base font-medium mt-3 leading-relaxed">
                  සමාන පද, විරුද්ධ පද, ප්‍රස්තාව පිරුළු, ව්‍යාකරණ, සහ <strong>අත්අකුරු (Sinhala Handwriting Tracing)</strong> ඇගයීම ඔස්සේ ශිෂ්‍යයාගේ දුර්‍වලතා හඳුනාගෙන ඊළඟ ප්‍රශ්න පත්‍ර ස්වයංක්‍රීයව අනුවර්තනය වේ.
                </p>
                <div className="flex flex-wrap items-center gap-4 mt-6">
                  ...
                  <div className="bg-white/15 backdrop-blur-sm px-4 py-2 rounded-2xl border border-white/20 text-xs font-bold">
                    ✍️ Tracing Threshold: <span className="text-amber-300 text-sm">≥ {TRACING_PASS_THRESHOLD}%</span>
                  </div>
                  <div className="bg-white/15 backdrop-blur-sm px-4 py-2 rounded-2xl border border-white/20 text-xs font-bold">
        ...
        {/* ══════════════════════════════════════════════════════════════
            VIEW 2: TEST QUESTION VIEW WITH INTEGRATED TRACING
           ══════════════════════════════════════════════════════════════ */}
        {viewMode === 'test' && currentQ && (
          <div className="space-y-6 max-w-3xl mx-auto animate-fade-in">
            <div className="bg-white/95 backdrop-blur-md rounded-3xl p-5 shadow-md border border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="bg-indigo-600 text-white text-xs font-black px-3.5 py-1.5 rounded-2xl">
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-[2.5rem] p-6 md:p-10 shadow-xl border border-white/60 relative overflow-hidden">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center gap-1.5 bg-indigo-50 text-indigo-800 text-xs font-black px-3.5 py-1.5 rounded-full border border-indigo-200">
                  ...
                  {currentQ.has_tracing && (
                    <span className="inline-flex items-center gap-1 bg-pink-50 text-pink-700 text-[11px] font-black px-2.5 py-1 rounded-full border border-pink-200">
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-2xl font-bold text-left transition-all flex items-center justify-between border-2 cursor-pointer ${
                        isSelected
                          ? 'bg-indigo-50 border-indigo-500 text-indigo-950 shadow-md transform scale-[1.02]'
              ...
              {/* Interactive 4-Line Ruled Canvas (Rendered ONLY after answer is selected) */}
              {currentQ.has_tracing && (
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              {currentQIndex < currentQuestions.length - 1 ? (
                <button
                  ...
                  className="px-6 py-3.5 bg-indigo-700 hover:bg-indigo-800 text-white rounded-2xl font-black text-sm shadow-md hover:shadow-lg transition-all flex items-center gap-2 cursor-pointer"
                >
                  ඊළඟ ප්‍රශ්නය
