  ...
  return (
    ...
    >
      ...
      <main className={`mx-auto px-4 ${viewMode === 'test' ? 'max-w-5xl pt-2 pb-4' : 'max-w-5xl pt-8 pb-16'}`}>
        ...
        {/* ══════════════════════════════════════════════════════════════
            VIEW 2: TEST QUESTION VIEW (COMPACT NO-SCROLL LAYOUT)
           ══════════════════════════════════════════════════════════════ */}
        {viewMode === 'test' && currentQ && (
          <div className="space-y-3 max-w-4xl mx-auto animate-fade-in">
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-3xl p-4 md:p-5 shadow-md border border-white/60 relative overflow-hidden">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center gap-1.5 bg-indigo-50 text-indigo-800 text-xs font-black px-3 py-1 rounded-full border border-indigo-200">
                  ...
                  {currentQ.has_tracing && (
                    <span className="inline-flex items-center gap-1 bg-pink-50 text-pink-700 text-[10px] font-black px-2 py-0.5 rounded-full border border-pink-200">
                          ...
                          return (
                            <button
                              ...
                              className={`p-2.5 md:p-3 rounded-xl font-bold text-left transition-all flex items-center justify-between border-2 cursor-pointer ${
                                isSelected
                                  ? 'bg-indigo-50 border-indigo-500 text-indigo-950 shadow-xs transform scale-[1.01]'
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              {currentQIndex < currentQuestions.length - 1 ? (
                <button
                  ...
                  className="px-5 py-2.5 bg-indigo-700 hover:bg-indigo-800 text-white rounded-xl font-black text-xs md:text-sm shadow-md hover:shadow-lg transition-all flex items-center gap-1.5 cursor-pointer"
                >
                  ඊළඟ ප්‍රශ්නය
