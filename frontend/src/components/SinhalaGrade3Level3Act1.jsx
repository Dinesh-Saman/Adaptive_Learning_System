...
// ── 5 Questions for Grade 3 Level 3 Activity 1 (සමාන පද තෝරන්න) ──
const LEVEL3_ACT1_QUESTIONS = [
  {
    id: 1,
    num: 1,
    targetWord: 'ලස්සන',
    correctSynonym: 'පියකරු',
    meaning: 'Beautiful / Pretty (ලස්සන = පියකරු)',
    imageEmoji: '🌸✨',
    fullSentence: 'පියකරු මලෙහි පැණි පිරී ඇත.',
    voicePrompt: 'ලස්සන යන වචනයට සමාන පදය තෝරන්න.',
    options: [
      { id: 'opt_1_1', text: 'පියකරු', isCorrect: true },
      { id: 'opt_1_2', text: 'නපුරු', isCorrect: false },
      { id: 'opt_1_3', text: 'උරු', isCorrect: false },
    ]
  },
  {
    id: 2,
    num: 2,
    targetWord: 'සතුට',
    correctSynonym: 'ප්‍රීතිය',
    meaning: 'Happiness / Joy (සතුට = ප්‍රීතිය)',
    imageEmoji: '😊🎉',
    fullSentence: 'තරඟය දිනූ පසු ප්‍රීතිය ඇති වේ.',
    voicePrompt: 'සතුට යන වචනයට සමාන පදය තෝරන්න.',
    options: [
      { id: 'opt_2_1', text: 'ප්‍රීතිය', isCorrect: true },
      { id: 'opt_2_2', text: 'එක', isCorrect: false },
      { id: 'opt_2_3', text: 'කණගාටුව', isCorrect: false },
    ]
  },
  {
    id: 3,
    num: 3,
    targetWord: 'වතුර',
    correctSynonym: 'දියවර',
    meaning: 'Water (වතුර = දියවර / ජලය)',
    imageEmoji: '💧🏞️',
    fullSentence: 'ජීවත්වීමට දියවර අත්‍යවශ්‍ය වේ.',
    voicePrompt: 'වතුර යන වචනයට සමාන පදය තෝරන්න.',
    options: [
      { id: 'opt_3_1', text: 'දියවර', isCorrect: true },
      { id: 'opt_3_2', text: 'ගල', isCorrect: false },
      { id: 'opt_3_3', text: 'මහජනයා', isCorrect: false },
    ]
  },
  {
    id: 4,
    num: 4,
    targetWord: 'ඇඟ',
    correctSynonym: 'ශරීරය',
    meaning: 'Body (ඇඟ = ශරීරය)',
    imageEmoji: '🏃‍♂️💪',
    fullSentence: 'ව්‍යායාම කිරීමෙන් ශරීරය නිරෝගී වේ.',
    voicePrompt: 'ඇඟ යන වචනයට සමාන පදය තෝරන්න.',
    options: [
      { id: 'opt_4_1', text: 'ශරීරය', isCorrect: true },
      { id: 'opt_4_2', text: 'කැමැත්ත', isCorrect: false },
      { id: 'opt_4_3', text: 'කවි', isCorrect: false },
    ]
  },
  {
    id: 5,
    num: 5,
    targetWord: 'සාගරය',
    correctSynonym: 'සමුද්‍රය',
    meaning: 'Ocean / Sea (සාගරය = සමුද්‍රය)',
    imageEmoji: '🌊🚢',
    fullSentence: 'ශ්‍රී ලංකාව සමුද්‍රයෙන් වට වී ඇත.',
    voicePrompt: 'සාගරය යන වචනයට සමාන පදය තෝරන්න.',
    options: [
      { id: 'opt_5_1', text: 'සමුද්‍රය', isCorrect: true },
      { id: 'opt_5_2', text: 'වැව', isCorrect: false },
      { id: 'opt_5_3', text: 'ගඟ', isCorrect: false },
    ]
  }
];
...
// ── Main Grade 3 Level 3 Activity 1 Component ──
export default function SinhalaGrade3Level3Act1({ onExit }) {
  ...
  const currentQ = LEVEL3_ACT1_QUESTIONS[currentIndex];
  ...
  const handleSelectOption = (opt) => {
    ...
    if (opt.isCorrect) {
      ...
      speakSinhala(`විශිෂ්ටයි! ${currentQ.targetWord} සඳහා සමාන පදය වන්නේ ${opt.text}. දැන් වාක්‍යය ලියන්න.`);
    } else {
      playSound('wrong');
  ...
  const handleNext = () => {
    playSound('click');
    if (currentIndex < LEVEL3_ACT1_QUESTIONS.length - 1) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-sky-400 via-purple-100 to-emerald-200 flex items-center justify-center p-4 font-sinhala">
        <div className="max-w-xl w-full bg-white rounded-[3rem] p-8 shadow-2xl border-8 border-yellow-300 text-center animate-bounce-short">
          ...
          <p className="text-slate-600 text-lg mb-2">ඔබ Level 3 Activity 1 සාර්ථකව අවසන් කළා!</p>
    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-400 via-sky-100 to-emerald-200 font-sinhala select-none relative overflow-x-hidden flex flex-col justify-between pb-6">
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-full py-2 px-6 shadow-md border-2 border-purple-300 flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs sm:text-sm md:text-base font-bold text-slate-800">
                🎯 පහත දී ඇති වචනයට <span className="text-purple-700 font-extrabold underline">සමාන අර්ථය ඇති පදය</span> තෝරා වාක්‍යය ලියන්න.
              </p>
            </div>
      ...
      <div className="max-w-4xl mx-auto w-full px-4 my-3 flex-1 flex flex-col justify-center">
        <div className="bg-white/95 backdrop-blur-md rounded-[2.5rem] p-6 md:p-8 shadow-2xl border-4 border-purple-200 flex flex-col gap-4 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h2 className="text-base sm:text-lg md:text-xl font-black text-purple-950">
                  "{currentQ.targetWord}" සඳහා සමාන පදය:
                </h2>
              </div>
            </div>
          ...
          {/* Middle: Target Word Box + 3 Radio Option Cards */}
          <div className="flex flex-col sm:flex-row items-center justify-between gap-5 my-1">
            ...
            <div className="w-36 h-36 sm:w-44 sm:h-44 rounded-3xl bg-gradient-to-tr from-amber-100 via-sky-100 to-purple-100 border-4 border-purple-300 shadow-lg flex flex-col items-center justify-center p-3 text-center flex-shrink-0">
              ...
              <span className="text-lg sm:text-xl font-black text-purple-950 mt-1">
                {currentQ.targetWord}
              </span>
            ...
            <div className="flex-1 w-full flex flex-col gap-2.5">
              <span className="text-xs font-black text-slate-600 uppercase tracking-wide">
                නිවැරදි සමාන පදය තෝරන්න (Select Synonym):
              </span>
          ...
          {isAnswered && (
            <div className="animate-fade-in">
              <div className="flex items-center gap-2 text-xs md:text-sm font-black text-emerald-900 bg-emerald-100/90 py-1.5 px-4 rounded-2xl border border-emerald-300 w-max">
                <span>📝</span>
                <span>"{currentQ.correctSynonym}" යන වචනය භාවිතා කර වාක්‍යය සම්පූර්ණ කරන්න:</span>
              </div>
