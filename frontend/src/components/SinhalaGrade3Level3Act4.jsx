...
// ── 5 Questions for Grade 3 Level 3 Activity 4 (දී ඇති අර්ථයට ගැළපෙන වචනය තෝරන්න) ──
const LEVEL3_ACT4_QUESTIONS = [
  {
    id: 1,
    num: 1,
    definition: 'ජලය නොමැති / තෙතමනය නැති',
    correctWord: 'වියලි',
    meaning: 'Dry / Waterless (ජලය නොමැති = වියලි)',
    imageEmoji: '🍂☀️',
    fullSentence: 'අපේ රුක්ගොමුවේ වියලි කොළ වැටී ඇත.',
    voicePrompt: 'ජලය නොමැති යන අර්ථයට ගැලපෙන වචනය තෝරන්න.',
    options: [
      { id: 'opt_1_1', text: 'වියලි', isCorrect: true },
      { id: 'opt_1_2', text: 'තෙත්', isCorrect: false },
      { id: 'opt_1_3', text: 'සිසිල්', isCorrect: false },
    ]
  },
  {
    id: 2,
    num: 2,
    definition: 'අධ්‍යාපනය ලබාදෙන ගුරුතුමන් සිටින ස්ථානය',
    correctWord: 'පාසල',
    meaning: 'School / Place of education (අධ්‍යාපනය ලබන තැන = පාසල)',
    imageEmoji: '🏫🎒',
    fullSentence: 'අපි සෑම දිනකම පාසලට යමු.',
    voicePrompt: 'අධ්‍යාපනය ලබන ස්ථානය කුමක්ද? ගැලපෙන වචනය තෝරන්න.',
    options: [
      { id: 'opt_2_1', text: 'පාසල', isCorrect: true },
      { id: 'opt_2_2', text: 'රෝහල', isCorrect: false },
      { id: 'opt_2_3', text: 'වෙළඳපොල', isCorrect: false },
    ]
  },
  {
    id: 3,
    num: 3,
    definition: 'අහසේ රාත්‍රියේ බබලන වස්තුව',
    correctWord: 'සඳ',
    meaning: 'Moon in the night sky (රාත්‍රියේ බබලන වස්තුව = සඳ)',
    imageEmoji: '🌙✨',
    fullSentence: 'අඳුරු රැයේ සඳ ඉතා ලස්සනයි.',
    voicePrompt: 'අහසේ රාත්‍රියේ බබලන වස්තුව කුමක්ද? ගැලපෙන වචනය තෝරන්න.',
    options: [
      { id: 'opt_3_1', text: 'සඳ', isCorrect: true },
      { id: 'opt_3_2', text: 'ඉර', isCorrect: false },
      { id: 'opt_3_3', text: 'වැස්ස', isCorrect: false },
    ]
  },
  {
    id: 4,
    num: 4,
    definition: 'අපට පෝෂ්‍යදායී කිරි දෙන සතෙකි',
    correctWord: 'එළදෙන',
    meaning: 'Cow that provides milk (කිරි දෙන සතෙකි = එළදෙන)',
    imageEmoji: '🐄🥛',
    fullSentence: 'එළදෙන අපට කිරි ලබාදෙයි.',
    voicePrompt: 'කිරි දෙන සතා කවුද? ගැලපෙන වචනය තෝරන්න.',
    options: [
      { id: 'opt_4_1', text: 'එළදෙන', isCorrect: true },
      { id: 'opt_4_2', text: 'ඇත්දෙන', isCorrect: false },
      { id: 'opt_4_3', text: 'මුවදෙන', isCorrect: false },
    ]
  },
  {
    id: 5,
    num: 5,
    definition: 'පොත් කියවීමට සහ අධ්‍යයනයට යන ස්ථානය',
    correctWord: 'පුස්තකාලය',
    meaning: 'Library / Place for reading books (පොත් කියවන ස්ථානය = පුස්තකාලය)',
    imageEmoji: '📚📖',
    fullSentence: 'අපි පොත් කියවීමට පුස්තකාලයට යමු.',
    voicePrompt: 'පොත් කියවීමට යන ස්ථානය කුමක්ද? ගැලපෙන වචනය තෝරන්න.',
    options: [
      { id: 'opt_5_1', text: 'පුස්තකාලය', isCorrect: true },
      { id: 'opt_5_2', text: 'ක්‍රීඩාංගණය', isCorrect: false },
      { id: 'opt_5_3', text: 'ඖෂධාලය', isCorrect: false },
    ]
  }
];
    ...
    <div className="w-full mt-3 p-3 bg-slate-50 rounded-2xl border-2 border-dashed border-sky-300">
      <div className="flex items-center justify-between mb-1.5">
        <span className="text-xs font-bold text-sky-900 flex items-center gap-1.5">
          <span>✍️</span>
          <span>වාක්‍යය තිත් ඉරි මත ලියන්න (Trace sentence on dotted guide):</span>
        </span>
        <button
          onClick={handleClear}
...
// ── Main Grade 3 Level 3 Activity 4 Component ──
export default function SinhalaGrade3Level3Act4({ onExit }) {
  ...
  const currentQ = LEVEL3_ACT4_QUESTIONS[currentIndex];
  ...
  const handleSelectOption = (opt) => {
    ...
    if (opt.isCorrect) {
      ...
      speakSinhala(`විශිෂ්ටයි! පිළිතුර වන්නේ ${opt.text}. දැන් වාක්‍යය ලියන්න.`);
    } else {
      playSound('wrong');
  ...
  const handleNext = () => {
    playSound('click');
    if (currentIndex < LEVEL3_ACT4_QUESTIONS.length - 1) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-sky-400 via-purple-100 to-emerald-200 flex items-center justify-center p-4 font-sinhala">
        <div className="max-w-xl w-full bg-white rounded-[3rem] p-8 shadow-2xl border-8 border-yellow-300 text-center animate-bounce-short">
          ...
          <p className="text-slate-600 text-lg mb-2">ඔබ Level 3 Activity 4 සාර්ථකව අවසන් කළා!</p>
    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-400 via-sky-100 to-emerald-200 font-sinhala select-none relative overflow-x-hidden flex flex-col justify-between pb-6">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex-1 max-w-lg bg-gradient-to-r from-purple-700 via-indigo-700 to-purple-800 text-white py-2 px-6 rounded-full shadow-lg border-2 border-yellow-300 text-center">
            <h1 className="text-sm md:text-base font-black tracking-wide text-yellow-200 drop-shadow">
              Activity 4: අර්ථයට ගැළපෙන වචනය තෝරන්න
            </h1>
          </div>
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-full py-2 px-6 shadow-md border-2 border-purple-300 flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs sm:text-sm md:text-base font-bold text-slate-800">
                🎯 දී ඇති <span className="text-purple-700 font-extrabold underline">අර්ථයට ගැළපෙන තනි වචනය</span> තෝරා වාක්‍යය ලියන්න.
              </p>
            </div>
      ...
      <div className="max-w-4xl mx-auto w-full px-4 my-3 flex-1 flex flex-col justify-center">
        <div className="bg-white/95 backdrop-blur-md rounded-[2.5rem] p-6 md:p-8 shadow-2xl border-4 border-purple-200 flex flex-col gap-4 relative overflow-hidden">
          ...
          {/* Middle: Definition Hero Box + 3 Radio Option Cards */}
          <div className="flex flex-col sm:flex-row items-center justify-between gap-5 my-1">
            
            {/* Target Meaning Box */}
            <div className="w-36 h-36 sm:w-44 sm:h-44 rounded-3xl bg-gradient-to-tr from-amber-100 via-sky-100 to-purple-100 border-4 border-purple-300 shadow-lg flex flex-col items-center justify-center p-3 text-center flex-shrink-0">
              <span className="text-5xl sm:text-6xl drop-shadow-md animate-pulse">
                {currentQ.imageEmoji}
              </span>
            ...
            <div className="flex-1 w-full flex flex-col gap-2.5">
              <span className="text-xs font-black text-slate-600 uppercase tracking-wide">
                නිවැරදි වචනය තෝරන්න (Select Word):
              </span>
