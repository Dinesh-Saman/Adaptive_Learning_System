...
const Footer = () => {
  return (
    <footer className="bg-slate-950 text-slate-400 pt-12 pb-8 border-t border-slate-800/80 mt-auto relative overflow-hidden text-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 mb-10">
          ...
          <div className="space-y-3">
            <Link to="/" className="inline-block group">
              <span className="font-black text-xl text-white tracking-tight font-sinhala block group-hover:text-indigo-300 transition-colors">
                නැණ පියස
              </span>
            ...
            <div className="flex flex-wrap gap-1.5 pt-1">
              <span className="bg-slate-900 text-indigo-300 border border-slate-800 text-[11px] font-bold px-2 py-0.5 rounded-md">
                Adaptive AI ⭐
              </span>
              <span className="bg-slate-900 text-emerald-300 border border-slate-800 text-[11px] font-bold px-2 py-0.5 rounded-md">
                Child Safe 🛡️
              </span>
            </div>
          </div>
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <Link to="/dashboard" className="text-slate-400 hover:text-white transition-colors flex items-center gap-2 group">
                  <Calculator className="w-3.5 h-3.5 text-blue-400 group-hover:scale-110 transition-transform" />
                  <span>Adaptive Mathematics (ගණිතය)</span>
                </Link>
              </li>
              <li>
                <Link to="/dashboard" className="text-slate-400 hover:text-white transition-colors flex items-center gap-2 group">
                  <Languages className="w-3.5 h-3.5 text-emerald-400 group-hover:scale-110 transition-transform" />
              ...
              <li>
                <Link to="/dashboard" className="text-slate-400 hover:text-white transition-colors flex items-center gap-2 group">
                  <Palette className="w-3.5 h-3.5 text-amber-400 group-hover:scale-110 transition-transform" />
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <Link to="/teacher/dashboard" className="text-slate-400 hover:text-white transition-colors flex items-center gap-2 group">
                  <GraduationCap className="w-3.5 h-3.5 text-indigo-400 group-hover:scale-110 transition-transform" />
              ...
              <li>
                <Link to="/about" className="text-slate-400 hover:text-white transition-colors flex items-center gap-2 group">
                  <BrainCircuit className="w-3.5 h-3.5 text-pink-400 group-hover:scale-110 transition-transform" />
