  ...
  return (
    <div className="max-w-5xl mx-auto p-6 w-full text-center min-h-[90vh]">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-8 border-t-8 border-blue-500 relative">
        {sessionState === 'menu' && (
          <div className="py-8">
            <h2 className="text-4xl font-bold mb-4 text-slate-800">Choose your maths topic</h2>
        ...
        {sessionState !== 'menu' && sessionState !== 'complete' && (
           <>
            <h2 className="text-3xl font-bold mb-2 text-blue-600">Math Diagnostic Assessment</h2>
            <p className="text-slate-500 mb-8">Grades 2-4 • Vision-Driven Telemetry Engine</p>
           </>
        )}
